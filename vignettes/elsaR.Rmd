...
#
# (plot_wad_inset <- cowplot::ggdraw() +
#   cowplot::draw_plot(plot_wad +
#     elsar_plot_optics()) +
#   cowplot::draw_plot(
#     plot_dist +
#       elsar_plot_optics() +
...
#         axis.ticks.x = ggplot2::element_blank()
#       ),
#     scale = 0.22, # size of inset plot compared to main plot
#     y = -0.3, # needs to be changed depending on plot dimensions
#     x = -0.28 # needs to be changed depending on plot dimensions
#   ))
```

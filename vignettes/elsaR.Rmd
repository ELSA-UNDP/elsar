...
(plot_wad <- elsar_plot_static_raster_c(raster_in = wadOut, type = "ggplot_raster",
                                        legend_title = "WAD"))
```
...
(plot_wad <- elsar_plot_static_raster_c(raster_in = wadOut, type = "ggplot_raster", custom_palette = custom_p,
                                       background = wad_dat) + 
    elsar_plot_optics())
```
...
(plot_wad_pas <- elsar_plot_static_raster_c(raster_in = wadOut, type = "ggplot_raster",
                                       background = wad_dat,
                                       legend_title = "WAD") +
...
(plot_wad_pas2 <- elsar_plot_static_raster_c(raster_in = wadOut, type = "ggplot_raster",
                                       background = wad_dat,
                                       legend_title = "WAD") +

...
If we are interested in the distribution, we can also plot the distribution of raster values. For this, we need to create two individual plots that we then combine into a single output plot:
